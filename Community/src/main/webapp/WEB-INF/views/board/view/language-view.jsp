...
<li>
	<div id='cmt1'>
		...
		<button type="button" id="btn_commentDelete" onclick="location.href='/kmweb/board/languageCommentDelete?postNo=${comment.postNo}&commentsNo=${comment.commentsNo}'">삭제</button>    
	</div>
	<div id='cmt2' style ='display:none'>
	<form method='post' action ="/kmweb/board/languageCommentUpdate">
