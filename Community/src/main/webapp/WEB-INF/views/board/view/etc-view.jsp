...
<button type="button" id="btn_update" onclick="location.href='/kmweb/board/etcCategoryUpdate?postNo=${view.postNo}'" >수정하기</button>
<button type="button" id="btn_delete" onclick="location.href='/kmweb/board/etcCategoryDelete?postNo=${view.postNo}'">삭제하기</button>
<button type="button" onclick="location.href='/kmweb/board/etcCategory'">목록</button>
<!-- 댓글 -->
...
<li>
	<div id='cmt1'>
		...
		<button type="button" id="btn_commentDelete" onclick="location.href='/kmweb/board/etcCommentDelete?postNo=${comment.postNo}&commentsNo=${comment.commentsNo}'">삭제</button>    
	</div>
	<div id='cmt2' style ='display:none'>
	<form method='post' action ="/kmweb/board/etcCommentUpdate">
...
<div id="replyForm">
    <form method ="post" action = "/kmweb/board/etcCommentReply">
