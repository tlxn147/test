...
<head>
<meta charset="UTF-8">
<title>certificate_category</title>
</head>
<body>
...
<button type="button" id="btn_update" onclick="location.href='/kmweb/board/certificateCategoryUpdate?postNo=${view.postNo}'" >수정하기</button>
<button type="button" id="btn_delete" onclick="location.href='/kmweb/board/certificateCategoryDelete?postNo=${view.postNo}'">삭제하기</button>
<button type="button" onclick="location.href='/kmweb/board/certificateCategory'">목록</button>
<!-- 댓글 -->
...
<li>
	<div id='cmt1'>
		...
		<button type="button" id="btn_commentDelete" onclick="location.href='/kmweb/board/certificateCommentDelete?postNo=${comment.postNo}&commentsNo=${comment.commentsNo}'">삭제</button>    
	</div>
	<div id='cmt2' style ='display:none'>
	<form method='post' action ="/kmweb/board/certificateCommentUpdate">
...
<div id="replyForm">
    <form method ="post" action = "/kmweb/board/certificateCommentReply">
