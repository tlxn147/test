...
<head>
<meta charset="UTF-8">
<title>publicServant_category</title>
</head>
<body>
...
<button type="button" id="btn_update" onclick="location.href='/kmweb/board/publicServantCategoryUpdate?postNo=${view.postNo}'" >수정하기</button>
<button type="button" id="btn_delete" onclick="location.href='/kmweb/board/publicServantCategoryDelete?postNo=${view.postNo}'">삭제하기</button>
<button type="button" onclick="location.href='/kmweb/board/publicServantCategory'">목록</button>
<!-- 댓글 -->
...
<li>
	<div id='cmt1'>
		...
		<button type="button" id="btn_commentDelete" onclick="location.href='/kmweb/board/publicServantCommentDelete?postNo=${comment.postNo}&commentsNo=${comment.commentsNo}'">삭제</button>    
	</div>
	<div id='cmt2' style ='display:none'>
	<form method='post' action ="/kmweb/board/publicServantCommentUpdate">
...
<div id="replyForm">
    <form method ="post" action = "/kmweb/board/publicServantCommentReply">
